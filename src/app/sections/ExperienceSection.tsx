...
export default function ExperienceSection() {
  ...
  useEffect(() => {
   ...
   return (
     <section 
        id="section3" 
        className="snap-start h-screen flex flex-col md:flex-row items-center justify-center md:justify-between px-40 mt-[5.5vh] bg-[#4831d4] overflow-hidden"
      >
      <div className='w-full md:w-1/2'>
      <h1
          className={`text-[#ccf381] md:max-w-[25vw] leading-none text-[4em] font-bold transform transition-all duration-500 ease-in-out delay-300 ${
        ...
        <p
          className={`text-white md:max-w-[27vw] leading-relaxed mt-4 transform transition-all duration-500 ease-in-out delay-300 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}
        >  
        ...
        <p
          className={`text-white md:max-w-[27vw] leading-relaxed mt-4 transform transition-all duration-500 ease-in-out delay-500 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}
        >  
